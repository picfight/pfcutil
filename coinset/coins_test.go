...
import (
	...
	"github.com/picfight/pfcutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    pfcutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() pfcutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value pfcutil.Amount, numConfs int64) coinset.Coin {
	h := fastsha256.New()
...
var (
	// should be two outpoints, with 1st one having 1.29994545PFC value.
	...
	testSimpleCoinTxValue0            = pfcutil.Amount(129994545)
	...
	testSimpleCoinTx, _               = pfcutil.NewTxFromBytes(testSimpleCoinTxBytes)
