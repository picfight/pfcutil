...
func TestMerkleBlock3(t *testing.T) {
	...
	blk, err := pfcutil.NewBlockFromBytes(blockBytes)
	if err != nil {
	...
	err = mBlock.PfcEncode(got, wire.ProtocolVersion, wire.LatestEncoding)
	if err != nil {
		t.Errorf("TestMerkleBlock3 PfcEncode failed: %v", err)
		return
	}
